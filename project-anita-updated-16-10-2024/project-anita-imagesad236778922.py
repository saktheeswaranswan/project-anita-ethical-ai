...
class BallSimulation:
    ...
    def draw_bins(self):
        ...
        scale_factor = (200 / max_bin_height) if max_bin_height > 0 else 1  # Scale to fit in the canvas height
    ...
    def save_histogram_as_png(self):
        ...
        plt.yticks(range(0, max(self.bins) + 1, max(1, max(self.bins) // 10)))  # Dynamic ticks
        plt.ylim(0, max(self.bins) + 5)  # Extend y-limits for visibility
